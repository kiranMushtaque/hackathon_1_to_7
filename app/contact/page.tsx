  ...
  return (
    <div className="bg-gray-50">
      ...
      <header className="text-center py-12 bg-[#FF9F0D] text-white">
        <h1 className="text-3xl md:text-4xl font-bold">Contact Foodtuck</h1>
        <p className="text-lg md:text-xl mt-2">We're here to assist you!</p>
      </header>
      ...
      <section className="container mx-auto px-4 py-16 mt-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h2 className="text-xl md:text-2xl font-bold mt-4">Visit Us</h2>
            <p className="mt-2 text-lg">1234 Foodtuck Restaurant</p>
          </div>

          {/* Phone */}
          <div className="flex flex-col items-center text-center">
            <FaPhoneAlt className="text-4xl text-[#FF9F0D]" />
            <h2 className="text-xl md:text-2xl font-bold mt-4">Call Us</h2>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h2 className="text-xl md:text-2xl font-bold mt-4">Email Us</h2>
